...
- `soksak-plugin-editor` 에 의존하고, 에디터의 확장 프로토콜(`editor.ext.register` 버스
...
`soksak-plugin-editor` — 에디터와 그 확장 프로토콜을 제공합니다. 이 플러그인을 켜면 스켈레톤이
의존성을 해소·설치합니다.
...
1. `soksak-plugin-editor`(의존성으로 자동 해소)와 이 플러그인을 활성화합니다.
